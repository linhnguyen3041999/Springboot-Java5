<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <c:url var="categoryURL" value="/admin/category-bin/list" />
<!-- Main content -->
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
         <div class="card-title">
                <form action="/admin/category-bin/search" method="post">
          ...
          <table class="table table-striped projects">
              ...
              <c:forEach var="item" items="${list}">
                      ...
                      <td class="project-actions text-right">
                          <a class="btn btn-warning btn-sm" href="/admin/category-bin/restore/${item.id}">
                              <i class="fa fa-reply" aria-hidden="true"></i>
                              Restore
                          </a>
                          <a class="btn btn-danger btn-sm" value="hello" onclick="warningBeforeDelete(${item.id})">
      ...
      <!-- /.card -->
       <form action="/admin/category-bin/list" id="formSubmit">
