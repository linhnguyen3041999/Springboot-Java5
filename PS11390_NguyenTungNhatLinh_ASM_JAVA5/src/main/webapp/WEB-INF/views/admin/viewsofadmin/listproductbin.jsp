...
<c:url var="productURL" value="/admin/product-bin/list" />
<!-- Main content -->
<section class="content">
	...
	<div class="card">
		<div class="card-header">
			<div class="card-title">
				<form action="/admin/product-bin/search" method="post">
					...
					<c:forEach var="item" items="${items}">
						<tr>
							...
							<td class="project-actions text-right">
							 <a class="btn btn-warning btn-sm" href="/admin/product-bin/restore/${item.id}">
                              <i class="fa fa-reply" aria-hidden="true"></i>
                              	Restore</a>
                              	<a class="btn btn-danger btn-sm"
								onclick="warningBeforeDelete(${item.id})"> <i
	...
	<!-- /.card -->
	<form action="/admin/product-bin/list" id="formSubmit">
